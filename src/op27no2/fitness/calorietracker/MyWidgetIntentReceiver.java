...
public class MyWidgetIntentReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if(intent.getAction().equals("pl.looksok.intent.action.CHANGE_PICTURE2")){
			v.vibrate(19);
			updateWidgetPictureAndButtonListener2(context, widgetId);
		}
		if(intent.getAction().equals("pl.looksok.intent.action.CHANGE_PICTURE3")){
			v.vibrate(25);
			updateWidgetPictureAndButtonListener3(context, widgetId);
		}
		if(intent.getAction().equals("pl.looksok.intent.action.CHANGE_PICTURE4")){
			v.vibrate(19);
			updateWidgetPictureAndButtonListener4(context,widgetId);
		}
		if(intent.getAction().equals("pl.looksok.intent.action.NEW_ACTIVITY")){
	...
	private void launchActivity(Context context, int appWidgetId) {
		...
		remoteViews.setOnClickPendingIntent(R.id.center, MyWidgetProvider.activityPending(context, appWidgetId));
		remoteViews.setOnClickPendingIntent(R.id.plus, MyWidgetProvider.buildButtonPendingIntent(context, appWidgetId));
		remoteViews.setOnClickPendingIntent(R.id.minus, MyWidgetProvider.buildButtonPendingIntent2(context, appWidgetId));
		remoteViews.setOnClickPendingIntent(R.id.plussmall, MyWidgetProvider.buildButtonPendingIntent3(context, appWidgetId));
		remoteViews.setOnClickPendingIntent(R.id.minussmall, MyWidgetProvider.buildButtonPendingIntent4(context, appWidgetId));
		MyWidgetProvider.pushWidgetUpdate(context.getApplicationContext(), remoteViews, appWidgetId);
